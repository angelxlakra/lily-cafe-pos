    ...
    <div className="bg-off-white border border-neutral-border rounded-lg p-4 shadow-sm">
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          ...
          {/* Customer name, read-only. Waiters record a kitchen note at order
              time rather than a name; this shows a name only when an admin set
              one. Changing an order needs a login, which this page does not
              have — corrections are made from the admin Active Orders screen. */}
          {order.customer_name && (
