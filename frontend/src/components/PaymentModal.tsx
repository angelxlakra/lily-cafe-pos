            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              >
                ...
                <span className={`flex items-center gap-2 text-2xl font-bold tabular-nums transition-colors duration-300 ${
                  ...
                  {hasLanded && (
                    <svg className="w-6 h-6 shrink-0 text-[color-mix(in_oklab,var(--color-lily-green),black_35%)] dark:text-lily-green-light" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <path
